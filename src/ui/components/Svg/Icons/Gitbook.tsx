...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <GradientSvg viewBox="0 0 64 64" {...props}>
      <linearGradient
        id="git-gradient"
